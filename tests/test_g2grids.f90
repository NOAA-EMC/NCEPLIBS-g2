...
!>
     ...
     & 48, -90000000, 359000000, 1000000, 1000000, 0 /)
       ...
       open(id, file = 'testdata_g2grids', status = 'old', &
     & action = 'read') 
       ...
       ! Although the function readgrids is indirectly tested in
       ! subroutines, it is necessary to be individually tested here.
