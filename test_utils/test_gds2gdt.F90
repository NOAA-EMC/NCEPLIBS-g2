...
program test_gds2gdt
   ...
   integer :: exp_gds_latlon(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 0, 0, 1000, 1000, 56, 1000, 1000, 1000, &
      1000, 1000, 0, 0, 0 /)
   integer :: exp_gds_mercator(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 1000, 56, 1000, 1000, 1000, 1000, &
      0, 1000, 1000, 0, 0, 0 /)
   integer :: exp_gds_lambert(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 1000, 56, 1000, 1000, 1000, 1000, &
      1000, 1000, 1000, 1000, 1000, 1000 /)
   integer :: exp_gds_gaussian(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 0, 0, 1000, 1000, 56, 1000, 1000, 1000, &
      1000, 1000, 0, 0, 0/)
   integer :: exp_gds_polar(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 1000, 56, -60000000, 1000, 1000, 1000, &
      1000, 1000, 0, 0, 0, 0/)
   integer :: exp_gds_curvilinear(MAXIGDS) = (/ 0, 0, 0, 0, 0, 0, 0, 1000, 1000, 0, 0, 0, 0, 56, 0, 0, 0, 0, 1000, 0, &
      0, 0 /)
