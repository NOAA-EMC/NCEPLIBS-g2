...
!>    This subroutine adds a Local Use Section (Section 2) to a GRIB2
!>    message. This routine is used with routines gribcreate(),
!>    addlocal(), addfield(), and gribend() to create a complete GRIB2
...
!>    @param[in] csec2 Character array containing information to be added to
!>    Section 2.
!>    @param[in] lcsec2 Number of bytes of character array csec2 to be added to
!>    Section 2.
