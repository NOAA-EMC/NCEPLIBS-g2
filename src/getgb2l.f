C>    @file
C>    @brief This subroutine read and unpack a local use section from a
C>    grib2 message.
C>    @author Stephen Gilbert @date 2002-05-07
C>

C>    This subroutine read and unpack a local use section from a grib2
C>    message. It decoded information for the selected grib field and
