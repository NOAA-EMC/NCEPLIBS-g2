!>    @file
!>    @brief This subroutine find and extracts a grib message from a file.
!>    @author Mark Iredell @date 1994-04-01
!>

!>    This subroutine find and extracts a grib message from a file.
!>    It reads a grib index file (or optionally the grib file itself) to
...
!>    grib file and unpacked. If the grib field is not found, then the
!>    return code will be nonzero.
!>
!>    PROGRAM HISTORY LOG:
!>    - 1994-04-01 Mark Iredell
!>    - 1995-10-31 Mark Iredell modularized portions of code into subprograms
...
!>    problems with array overloading. Because of this users are 
