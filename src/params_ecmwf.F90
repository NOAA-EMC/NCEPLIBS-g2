...
contains
  ...
  subroutine param_ecmwf_g1_to_g2(g1val, g1ver, g2disc, g2cat, g2num)
    ...
    do n=1, MAXPARAM
       if ( paramlist(n)%grib1val.eq.g1val .AND. paramlist(n)%g1tblver.eq.g1ver ) then
    ...
    print *, 'param_ecmwf_g1_to_g2:GRIB1 param ', g1val,  ' not found.',  &
         ' for table version ', g1ver
  end subroutine param_ecmwf_g1_to_g2
  ...
  subroutine param_ecmwf_g2_to_g1(g2disc, g2cat, g2num, g1val, g1ver)
    ...
    do n=1, MAXPARAM
       if (paramlist(n)%grib2dsc.eq.g2disc.AND. paramlist(n)%grib2cat.eq.g2cat.AND. &
    ...
    print *, 'param_ecmwf_g2_to_g1:GRIB2 param ', g2disc, g2cat,  g2num, ' not found.'
  end subroutine param_ecmwf_g2_to_g1

end module params_ecmwf
