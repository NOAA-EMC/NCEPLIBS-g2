...
!>    determine how many data fields exist in a given GRIB message.It
!>    may not always be possible to expand a bit-mapped data field. If a
!>    pre-defined bit-map is used and not included in the GRIB2 message
!>    itself, this routine would not have the necessary information to
!>    expand the data. In this case, gfld\%expanded would be set to 0
!>    (false), regardless of the value of input argument expand.
!>
!>    @author Stephen Gilbert @date 2000-05-26
!>
