...
!> This subroutine packs up a GRIB2 data field. It uses a complex
!> packing algorithm as defined in the GRIB2 documention and supports
!> GRIB2 complex packing templates with or without spatial differences
