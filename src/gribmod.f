...
!>    PROGRAM HISTORY LOG:
!>    - 2002-01-23 Stephen Gilbert
!>    - 2007-04-24 Boi Vuong Added GDT 3.204 Curvilinear Orthogonal Grids
!>    - 2008-05-29 Boi Vuong Added GDT 3.32768 Rotate Lat/Lon E-grid
!>    - 2009-02-17 Boi Vuong Allow negative scale factors and limits for
!>    Templates 4.5 and 4.9
!>    - 2009-12-14 Boi Vuong 
!>     - Fixed bug in routine getidx.f
!>     - Modified to increase length of seek(512)
!>     - Added Templates (Satellite Product) 4.31
!>     - Added Templates (ICAO WAFS) 4.15
!>    - 2013-05-07 Boi Vuong Initialized all pointers to null()
!>    - 2013-08-29 Boi Vuong Changed version number 2.5.0
!>    - 2015-11-01 Boi Vuong Changed version number 2.6.0
!>    - 2017-18-01 Boi Vuong Changed version number 3.1.0
!>    
!>    This Fortran Module contains the declaration of derived type
!>    gribfield. If variable gfld is declared of type gribfield,
...
!>    - gfld\%idsect(4) GRIB Local Tables Version Number (Code Table 1.1)
...
!>
      ...
      character(len=12) :: G2_VERSION="g2lib-3.4.5" !< Library version.
