!>    @file
!>    @brief This subroutine packs up a Grid Definition Section (Section
!>    3) and adds it to a GRIB2 message.
...
!>
!>    @note: Note that the Local Use Section (Section 2) can only
!>    follow Section 1 or Section 7 in a GRIB2 message.
!>
!>    @author Stephen Gilbert @date 2000-05-01
!>
