...
export LIB=../${COMP}/libg2_v${version}_4.a
export MODDIR=../${COMP}/include/g2_v${version}_4
mkdir -p $(dirname $LIB) $MODDIR
make -f makefile_4_cray

export LIB=../${COMP}/libg2_v${version}_d.a
export MODDIR=../${COMP}/include/g2_v${version}_d
mkdir -p $(dirname $LIB) $MODDIR
